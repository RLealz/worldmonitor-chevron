...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  scm: {
    ...
    description: 'Public-data supply chain dashboard for energy operators, tracking chokepoints, sanctions, trade policy, storage, pipelines, fuel shortages, and disruption signals without proprietary claims.',
    keywords: 'energy scm demo, supply chain dashboard, public data, open source intelligence, energy logistics, trade routes, chokepoints, sanctions, fuel shortages, pipeline status, storage facilities, supply disruption, commodity flows, maritime risk, energy security',
    url: 'https://scm.worldmonitor.app/',
    siteName: 'Energy SCM Demo',
    shortName: 'SCMDemo',
    subject: 'Public-Data Energy Supply Chain Monitoring and Risk Intelligence',
    classification: 'Supply Chain Dashboard, Energy Risk Monitor, OSINT Demo',
    categories: ['business', 'news'],
    features: [
      'Public-data energy supply chain monitoring',
      'Chokepoint and trade route risk tracking',
      'Pipeline and storage infrastructure visibility',
      'Fuel shortage and disruption alerts',
      'Sanctions and trade policy watchlists',
      'Commodity and logistics context panels',
      'Open-source maritime and infrastructure signals',
      'Demo-safe operator briefing workspace',
    ],
  },
};
