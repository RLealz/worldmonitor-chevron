...
const SCM_PANELS: Record<string, PanelConfig> = {
  ...
  'trade-policy': { name: 'Trade-Control Screening', enabled: true, priority: 1 },
  'sanctions-pressure': { name: 'Sanctions Screening Signals', enabled: true, priority: 1 },
...
export const VARIANT_PANEL_OVERRIDES: Partial<Record<string, Partial<Record<string, Partial<PanelConfig>>>>> = {
  ...
  scm: {
    ...
    'trade-policy':      { name: 'Trade-Control Screening' },
    'sanctions-pressure': { name: 'Sanctions Screening Signals' },
